...
1. **Preprocessing:** The preprocessor takes a C++ source code file and deals with the `#include`s, `#define`s and other preprocessor directives. The output of this step is a _pure_ C++ file without pre-processor directives.
...
It's at this stage that _regular_ compiler errors occur, like syntax errors or failed resolution errors are reported.
